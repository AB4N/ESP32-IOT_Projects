...
- **MQTT Publisher** - Publishes simulated energy data (watts, voltage) to HiveMQ broker every 5 seconds using JSON payloads. Foundation for the smart energy tracker project.
