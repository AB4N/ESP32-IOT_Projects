...
- **MQTT Publisher** - Publishes simulated energy data (watts, voltage) to HiveMQ broker every 2 seconds using JSON payloads. Foundation for the smart energy tracker project.
